...
/* 32 */     player.fix();
/*    */     
/* 34 */     Embed embed = new Embed(EmbedType.SUCCESS, "", "Gave " + guild.getMemberById(ID).getAsMention() + " +1 win and updated their elo", 1);
/* 35 */     msg.replyEmbeds(embed.build(), new net.dv8tion.jda.api.entities.MessageEmbed[0]).queue();
/*    */   }
/*    */ }


/* Location:              C:\Users\JineshGamer\Downloads\RankedBot.jar!\com\kasp\rankedbot\commands\game\WinCmd.class
