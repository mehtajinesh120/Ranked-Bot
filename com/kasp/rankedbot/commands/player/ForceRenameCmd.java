...
/* 31 */       Embed embed = new Embed(EmbedType.ERROR, "Error", Msg.getMsg("player-not-registered"), 1);
...
/*    */     
/* 39 */     Player player = PlayerCache.getPlayer(ID);
/* 40 */     player.setIgn(ign);
/* 41 */     player.fix();
/*    */     
...
/* Location:              C:\Users\JineshGamer\Downloads\RankedBot.jar!\com\kasp\rankedbot\commands\player\ForceRenameCmd.class
