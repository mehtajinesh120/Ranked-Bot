...
/* 41 */       Embed embed = new Embed(EmbedType.ERROR, "Error", Msg.getMsg("clan-leader"), 1);
/* 42 */       msg.replyEmbeds(embed.build(), new net.dv8tion.jda.api.entities.MessageEmbed[0]).queue();
/*    */       
/*    */       return;
/*    */     } 
/* 46 */     clan.getMembers().remove(player);
/*    */     
/* 48 */     Embed reply = new Embed(EmbedType.SUCCESS, "", Msg.getMsg("clan-left"), 1);
/* 49 */     msg.replyEmbeds(reply.build(), new net.dv8tion.jda.api.entities.MessageEmbed[0]).queue();
/*    */   }
/*    */ }


/* Location:              C:\Users\JineshGamer\Downloads\RankedBot.jar!\com\kasp\rankedbot\commands\clan\ClanLeaveCmd.class
