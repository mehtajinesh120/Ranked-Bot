...
/* 45 */       Embed reply = new Embed(EmbedType.ERROR, "Error", Msg.getMsg("already-has-theme"), 1);
/* 46 */       msg.replyEmbeds(reply.build(), new net.dv8tion.jda.api.entities.MessageEmbed[0]).queue();
/*    */       
/*    */       return;
/*    */     } 
/* 50 */     player.giveTheme(theme);
/*    */     
/* 52 */     Embed embed = new Embed(EmbedType.SUCCESS, "", "You have given " + guild.getMemberById(ID).getAsMention() + " `" + theme.getName() + "` theme", 1);
/* 53 */     msg.replyEmbeds(embed.build(), new net.dv8tion.jda.api.entities.MessageEmbed[0]).queue();
/*    */   }
/*    */ }


/* Location:              C:\Users\JineshGamer\Downloads\RankedBot.jar!\com\kasp\rankedbot\command\\utilities\GiveThemeCmd.class
