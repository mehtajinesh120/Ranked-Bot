...
/*  214 */     if (this._inputStream != null) {
/*  215 */       int space = this._inputBuffer.length;
/*  216 */       if (space == 0) {
/*  217 */         return false;
/*      */       }
/*      */       
/*  220 */       int count = this._inputStream.read(this._inputBuffer, 0, space);
/*  221 */       if (count > 0) {
/*  222 */         this._inputPtr = 0;
/*  223 */         this._inputEnd = count;
/*      */         
/*  225 */         this._currInputProcessed += this._inputEnd;
/*  226 */         this._currInputRowStart -= this._inputEnd;
/*      */ 
/*      */ 
/*      */ 
/*      */         
/*  231 */         this._nameStartOffset -= bufSize;
/*      */         
/*  233 */         return true;
/*      */       } 
/*      */       
...
/*      */       }
/*      */       
/* 3284 */       int ch = this._inputBuffer[this._inputPtr++];
/* 3285 */       int digit = CharTypes.charToHex(ch);
/* 3286 */       if (digit < 0) {
/* 3287 */         _reportUnexpectedChar(ch & 0xFF, "expected a hex-digit for character escape sequence");
/*      */       }
...
/* Location:              C:\Users\JineshGamer\Downloads\RankedBot.jar!\com\fasterxml\jackson\core\json\UTF8StreamJsonParser.class
