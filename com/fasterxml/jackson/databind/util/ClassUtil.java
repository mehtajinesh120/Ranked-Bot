...
/*  964 */     return Enum.class.isAssignableFrom(rawType);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  976 */     if (!s.isEmpty()) {
/*  977 */       return findEnumType(s.iterator().next());
/*      */     }
/*      */     
/*  980 */     return EnumTypeLocator.instance.enumTypeFor(s);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  991 */     if (!m.isEmpty()) {
/*  992 */       return findEnumType(m.keySet().iterator().next());
/*      */     }
/*      */     
/*  995 */     return EnumTypeLocator.instance.enumTypeFor(m);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1008 */     Class<?> ec = en.getClass();
/* 1009 */     if (ec.getSuperclass() != Enum.class) {
/* 1010 */       ec = ec.getSuperclass();
/*      */     }
/* 1012 */     return (Class)ec;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1025 */     if (cls.getSuperclass() != Enum.class) {
/* 1026 */       cls = cls.getSuperclass();
/*      */     }
/* 1028 */     return (Class)cls;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1044 */     Field[] fields = getDeclaredFields(enumClass);
/* 1045 */     for (Field field : fields) {
/* 1046 */       if (field.isEnumConstant()) {
/* 1047 */         Annotation defaultValueAnnotation = field.getAnnotation(annotationClass);
/* 1048 */         if (defaultValueAnnotation != null) {
/* 1049 */           String name = field.getName();
/* 1050 */           for (Enum<?> enumValue : (Enum[])enumClass.getEnumConstants()) {
/* 1051 */             if (name.equals(enumValue.name())) {
/* 1052 */               return enumValue;
/*      */             }
/*      */           } 
/*      */         } 
/*      */       } 
...
/* 1078 */     return (impl == null || isJacksonStdImpl(impl.getClass()));
/*      */   }
/*      */   
/*      */   public static boolean isJacksonStdImpl(Class<?> implClass) {
/* 1082 */     return (implClass.getAnnotation(JacksonStdImpl.class) != null);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1098 */     Package pkg = cls.getPackage();
/* 1099 */     return (pkg == null) ? null : pkg.getName();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1106 */     return (!isObjectOrPrimitive(cls) && cls.getEnclosingMethod() != null);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1113 */     return cls.getDeclaredFields();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1120 */     return cls.getDeclaredMethods();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1127 */     if (isObjectOrPrimitive(cls)) {
/* 1128 */       return NO_ANNOTATIONS;
/*      */     }
/* 1130 */     return cls.getDeclaredAnnotations();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1143 */       return getDeclaredMethods(cls);
/* 1144 */     } catch (NoClassDefFoundError ex) {
/*      */       Class<?> contextClass;
/*      */       
/* 1147 */       ClassLoader loader = Thread.currentThread().getContextClassLoader();
/* 1148 */       if (loader == null)
/*      */       {
/* 1150 */         throw ex;
/*      */       }
/*      */       
/*      */       try {
/* 1154 */         contextClass = loader.loadClass(cls.getName());
/* 1155 */       } catch (ClassNotFoundException e) {
/* 1156 */         ex.addSuppressed(e);
/* 1157 */         throw ex;
/*      */       } 
/* 1159 */       return contextClass.getDeclaredMethods();
/*      */     } 
/*      */   }
/*      */ 
/*      */ 
...
/* 1169 */     if (cls.isInterface() || isObjectOrPrimitive(cls)) {
/* 1170 */       return NO_CTORS;
/*      */     }
/* 1172 */     Constructor[] arrayOfConstructor = (Constructor[])cls.getDeclaredConstructors();
/* 1173 */     int len = arrayOfConstructor.length;
/* 1174 */     Ctor[] result = new Ctor[len];
/* 1175 */     for (int i = 0; i < len; i++) {
/* 1176 */       result[i] = new Ctor(arrayOfConstructor[i]);
/*      */     }
/* 1178 */     return result;
/*      */   }
/*      */ 
...
/* 1188 */     return isObjectOrPrimitive(cls) ? null : cls.getDeclaringClass();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1195 */     return cls.getGenericSuperclass();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1202 */     return cls.getGenericInterfaces();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1210 */     return isObjectOrPrimitive(cls) ? null : cls.getEnclosingClass();
/*      */   }
/*      */   
/*      */   private static Class<?>[] _interfaces(Class<?> cls) {
/* 1214 */     return cls.getInterfaces();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 1229 */     static final EnumTypeLocator instance = new EnumTypeLocator();
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/* 1237 */     private final Field enumSetTypeField = locateField(EnumSet.class, "elementType", Class.class);
/* 1238 */     private final Field enumMapTypeField = locateField(EnumMap.class, "elementType", Class.class);
/*      */ 
/*      */ 
/*      */ 
/*      */     
/*      */     public Class<? extends Enum<?>> enumTypeFor(EnumSet<?> set) {
/* 1244 */       if (this.enumSetTypeField != null) {
/* 1245 */         return (Class<? extends Enum<?>>)get(set, this.enumSetTypeField);
/*      */       }
/* 1247 */       throw new IllegalStateException("Cannot figure out type for EnumSet (odd JDK platform?)");
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public Class<? extends Enum<?>> enumTypeFor(EnumMap<?, ?> set) {
/* 1253 */       if (this.enumMapTypeField != null) {
/* 1254 */         return (Class<? extends Enum<?>>)get(set, this.enumMapTypeField);
/*      */       }
/* 1256 */       throw new IllegalStateException("Cannot figure out type for EnumMap (odd JDK platform?)");
/*      */     }
/*      */ 
/*      */     
/*      */     private Object get(Object bean, Field field) {
/*      */       try {
/* 1262 */         return field.get(bean);
/* 1263 */       } catch (Exception e) {
/* 1264 */         throw new IllegalArgumentException(e);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     private static Field locateField(Class<?> fromClass, String expectedName, Class<?> type) {
/* 1270 */       Field found = null;
/*      */       
/* 1272 */       Field[] fields = ClassUtil.getDeclaredFields(fromClass);
/* 1273 */       for (Field f : fields) {
/* 1274 */         if (expectedName.equals(f.getName()) && f.getType() == type) {
/* 1275 */           found = f;
/*      */           
/*      */           break;
/*      */         } 
/*      */       } 
/* 1280 */       if (found == null) {
/* 1281 */         for (Field f : fields) {
/* 1282 */           if (f.getType() == type) {
/*      */             
/* 1284 */             if (found != null) return null; 
/* 1285 */             found = f;
/*      */           } 
/*      */         } 
/*      */       }
/* 1289 */       if (found != null) {
/*      */         try {
/* 1291 */           found.setAccessible(true);
/* 1292 */         } catch (Throwable throwable) {}
/*      */       }
/* 1294 */       return found;
/*      */     }
/*      */   }
...
/*      */ 
/*      */     
/* 1318 */     private int _paramCount = -1;
/*      */     
/*      */     public Ctor(Constructor<?> ctor) {
/* 1321 */       this._ctor = ctor;
/*      */     }
/*      */     
/*      */     public Constructor<?> getConstructor() {
/* 1325 */       return this._ctor;
/*      */     }
/*      */     
/*      */     public int getParamCount() {
/* 1329 */       int c = this._paramCount;
/* 1330 */       if (c < 0) {
/* 1331 */         c = (this._ctor.getParameterTypes()).length;
/* 1332 */         this._paramCount = c;
/*      */       } 
/* 1334 */       return c;
/*      */     }
/*      */     
/*      */     public Class<?> getDeclaringClass() {
/* 1338 */       return this._ctor.getDeclaringClass();
/*      */     }
/*      */     
/*      */     public Annotation[] getDeclaredAnnotations() {
/* 1342 */       Annotation[] result = this._annotations;
/* 1343 */       if (result == null) {
/* 1344 */         result = this._ctor.getDeclaredAnnotations();
/* 1345 */         this._annotations = result;
/*      */       } 
/* 1347 */       return result;
/*      */     }
/*      */     
/*      */     public Annotation[][] getParameterAnnotations() {
/* 1351 */       Annotation[][] result = this._paramAnnotations;
/* 1352 */       if (result == null) {
/* 1353 */         result = this._ctor.getParameterAnnotations();
/* 1354 */         this._paramAnnotations = result;
/*      */       } 
/* 1356 */       return result;
/*      */     }
/*      */   }
...
/* Location:              C:\Users\JineshGamer\Downloads\RankedBot.jar!\com\fasterxml\jackson\databin\\util\ClassUtil.class
