...
/* 284 */       if (p.hasToken(JsonToken.VALUE_STRING)) {
/*     */         
/* 286 */         char[] buffer = p.getTextCharacters();
/* 287 */         int offset = p.getTextOffset();
/* 288 */         int len = p.getTextLength();
/*     */         
/* 290 */         char[] result = new char[len];
/* 291 */         System.arraycopy(buffer, offset, result, 0, len);
/* 292 */         return result;
/*     */       } 
/* 294 */       if (p.isExpectedStartArrayToken()) {
/*     */         
/* 296 */         StringBuilder sb = new StringBuilder(64);
/*     */         JsonToken t;
...
/*     */       } 
/*     */       
/* 322 */       if (p.hasToken(JsonToken.VALUE_EMBEDDED_OBJECT)) {
...
/* 471 */       JsonToken t = p.currentToken();
/*     */ 
/*     */       
...
/*     */       byte value;
/* 541 */       JsonToken t = p.currentToken();
...
/* Location:              C:\Users\JineshGamer\Downloads\RankedBot.jar!\com\fasterxml\jackson\databind\deser\std\PrimitiveArrayDeserializers.class
