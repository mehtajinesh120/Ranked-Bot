...
/*     */       return;
/*     */     } 
/* 121 */     gen.writeStartArray(value);
/* 122 */     serializeContents(value, gen, provider);
...
/* 131 */     WritableTypeId typeIdDef = typeSer.writeTypePrefix(g, typeSer
/* 132 */         .typeId(value, JsonToken.START_ARRAY));
/*     */     
/* 134 */     g.setCurrentValue(value);
/* 135 */     serializeContents(value, g, provider);
/* 136 */     typeSer.writeTypeSuffix(g, typeIdDef);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 146 */     if (this._unwrapSingle == null) {
/* 147 */       return provider.isEnabled(SerializationFeature.WRITE_SINGLE_ELEM_ARRAYS_UNWRAPPED);
/*     */     }
/* 149 */     return this._unwrapSingle.booleanValue();
/*     */   }
/*     */ }


/* Location:              C:\Users\JineshGamer\Downloads\RankedBot.jar!\com\fasterxml\jackson\databind\ser\std\ArraySerializerBase.class
