...
/*     */       return;
/*     */     } 
/* 247 */     gen.writeStartArray(value);
/* 248 */     serializeContents(value, gen, provider);
...
/* 256 */     WritableTypeId typeIdDef = typeSer.writeTypePrefix(g, typeSer
/* 257 */         .typeId(value, JsonToken.START_ARRAY));
/*     */     
/* 259 */     g.setCurrentValue(value);
/* 260 */     serializeContents(value, g, provider);
/* 261 */     typeSer.writeTypeSuffix(g, typeIdDef);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 272 */     ObjectNode o = createSchemaNode("array", true);
/* 273 */     if (this._elementSerializer != null) {
/* 274 */       JsonNode schemaNode = null;
/* 275 */       if (this._elementSerializer instanceof SchemaAware) {
/* 276 */         schemaNode = ((SchemaAware)this._elementSerializer).getSchema(provider, null);
/*     */       }
/* 278 */       if (schemaNode == null) {
/* 279 */         schemaNode = JsonSchema.getDefaultSchemaNode();
/*     */       }
/* 281 */       o.set("items", schemaNode);
/*     */     } 
/* 283 */     return (JsonNode)o;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 290 */     JsonSerializer<?> valueSer = this._elementSerializer;
/* 291 */     if (valueSer == null)
/*     */     {
/*     */       
/* 294 */       if (this._elementType != null) {
/* 295 */         valueSer = visitor.getProvider().findValueSerializer(this._elementType, this._property);
/*     */       }
/*     */     }
/* 298 */     visitArrayFormat(visitor, typeHint, valueSer, this._elementType);
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   protected final JsonSerializer<Object> _findAndAddDynamic(PropertySerializerMap map, Class<?> type, SerializerProvider provider) throws JsonMappingException {
/* 304 */     PropertySerializerMap.SerializerAndMapResult result = map.findAndAddSecondarySerializer(type, provider, this._property);
/*     */     
/* 306 */     if (map != result.map) {
/* 307 */       this._dynamicSerializers = result.map;
/*     */     }
/* 309 */     return result.serializer;
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   protected final JsonSerializer<Object> _findAndAddDynamic(PropertySerializerMap map, JavaType type, SerializerProvider provider) throws JsonMappingException {
/* 315 */     PropertySerializerMap.SerializerAndMapResult result = map.findAndAddSecondarySerializer(type, provider, this._property);
/* 316 */     if (map != result.map) {
/* 317 */       this._dynamicSerializers = result.map;
/*     */     }
/* 319 */     return result.serializer;
/*     */   }
/*     */ }


/* Location:              C:\Users\JineshGamer\Downloads\RankedBot.jar!\com\fasterxml\jackson\databind\ser\std\AsArraySerializerBase.class
