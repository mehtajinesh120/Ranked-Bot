...
/*     */ 
/*     */     
/* 116 */     s.add("org.apache.commons.dbcp.datasources.PerUserPoolDataSource");
/* 117 */     s.add("org.apache.commons.dbcp.datasources.SharedPoolDataSource");
/* 118 */     s.add("com.p6spy.engine.spy.P6DataSource");
/*     */ 
/*     */     
/* 121 */     s.add("org.apache.log4j.receivers.db.DriverManagerConnectionSource");
/* 122 */     s.add("org.apache.log4j.receivers.db.JNDIConnectionSource");
/*     */ 
/*     */     
/* 125 */     s.add("net.sf.ehcache.transaction.manager.selector.GenericJndiSelector");
/* 126 */     s.add("net.sf.ehcache.transaction.manager.selector.GlassfishSelector");
/*     */     
/* 128 */     DEFAULT_NO_DESER_CLASS_NAMES = Collections.unmodifiableSet(s);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 134 */   protected Set<String> _cfgIllegalClassNames = DEFAULT_NO_DESER_CLASS_NAMES;
/*     */   
/* 136 */   private static final SubTypeValidator instance = new SubTypeValidator();
/*     */ 
/*     */   
...
/* 147 */     Class<?> raw = type.getRawClass();
/* 148 */     String full = raw.getName();
/*     */ 
/*     */ 
/*     */     
/* 152 */     if (!this._cfgIllegalClassNames.contains(full))
/*     */     
/*     */     { 
/*     */ 
/*     */ 
/*     */ 
/*     */       
/* 159 */       if (!raw.isInterface())
/*     */       {
/* 161 */         if (full.startsWith("org.springframework."))
/* 162 */         { for (Class<?> cls = raw; cls != null && cls != Object.class; ) {
/* 163 */             String name = cls.getSimpleName();
/*     */             
/* 165 */             if (!"AbstractPointcutAdvisor".equals(name)) { if ("AbstractApplicationContext"
/*     */                 
/* 167 */                 .equals(name))
/*     */                 // Byte code: goto -> 134  cls = cls.getSuperclass(); }
/*     */              // Byte code: goto -> 134
/*     */           }  }
/* 171 */         else if (full.startsWith("com.mchange.v2.c3p0."))
/*     */         
/*     */         { 
/*     */ 
/*     */ 
/*     */ 
/*     */           
/* 178 */           if (full.endsWith("DataSource"))
/*     */           
/*     */           { 
/*     */ 
/*     */ 
/*     */ 
/*     */             
/* 185 */             ctxt.reportBadTypeDefinition(beanDesc, "Illegal type (%s) to deserialize: prevented for security reasons", new Object[] { full }); return; }  }  }  return; }  ctxt.reportBadTypeDefinition(beanDesc, "Illegal type (%s) to deserialize: prevented for security reasons", new Object[] { full });
/*     */   }
/*     */ }


/* Location:              C:\Users\JineshGamer\Downloads\RankedBot.jar!\com\fasterxml\jackson\databind\jsontype\impl\SubTypeValidator.class
