...
/*     */ 
/*     */   
/*  47 */   protected PreparedStatement getGeneratedKeys = null;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*  62 */     if (this.conn == null) {
/*  63 */       throw new SQLException("connection closed");
/*     */     }
/*     */   }
/*     */ 
/*     */   
...
/* 160 */       return "null";
/*     */     }
/* 162 */     return String.format("'%s'", new Object[] { tableName });
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 191 */   protected static final Pattern PK_UNNAMED_PATTERN = Pattern.compile(".*\\sPRIMARY\\s+KEY\\s+\\((.*?,+.*?)\\).*", 34);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 197 */   protected static final Pattern PK_NAMED_PATTERN = Pattern.compile(".*\\sCONSTRAINT\\s+(.*?)\\s+PRIMARY\\s+KEY\\s+\\((.*?)\\).*", 34);
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/* Location:              C:\Users\JineshGamer\Downloads\RankedBot.jar!\org\sqlite\core\CoreDatabaseMetaData.class
